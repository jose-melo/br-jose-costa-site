...
export const initialPage = {
	[Languages.ptBr]: "Página inicial",
	[Languages.fr]: "Page d'accueil",
	[Languages.en]: "Homepage"
}

export const langBtnText = {
	[Languages.ptBr]: "pt 🇧🇷",
	[Languages.fr]: "fr 🇫🇷",
	[Languages.en]: "en 🇺🇸"
}
...
export const introduction = {
	[Languages.ptBr]: "Esta é a landing-page para meus projetos pessoais! Aqui, vou \
	...
	[Languages.fr]: "C'est la page d'accueil pour mes projets personnels ! \
	Ici, je vais donner accès à des programmes que j'ai créés et \
	tester des choses intéressantes. Pour l'instant il n'y a rien ici 😔, \
	mais au fur et à mesure je rajouterai des choses.",
	[Languages.en]: "This is the landing-page for my personal projects! Here, \
	I'll provide access to some programs I made and test some interesting stuff. \
...
export const card3 = {
	[Languages.ptBr]: "Se quiser ver outros repositórios",
	[Languages.fr]: "Si vous voulez voir d'autres dépôts",
	[Languages.en]: "If you want to see other repositories"
}

export const card3Title = {
	[Languages.ptBr]: "GitHub",
	[Languages.fr]: "GitHub",
	[Languages.en]: "GitHub"
}
...
export const card2Title = {
	[Languages.ptBr]: "Simulações e animações",
	[Languages.fr]: "Simulations et animations ",
	[Languages.en]: "Simulations and animations"
}

export const card1Link = "https://www.instagram.com/josemelocosta/";

export const card1Title = {
	[Languages.ptBr]: "Instagram",
	[Languages.fr]: "Instagram",
	[Languages.en]: "Instagram"
}

export const card1 = {
	[Languages.ptBr]: "Ideal para você acompanhar meu dia a dia.",
	[Languages.fr]: "Un endroit idéal pour suivre mon quotidien.",
	[Languages.en]: "Great place for you to follow my day to day"
}

export const catch_phrase = {
	[Languages.ptBr]: "Cuidado: vou fazer você se apaixonar por computacao",
	[Languages.fr]: "Attention : je vais vous faire aimer l'informatique",
	[Languages.en]: "Beware: I'm going to make you fall in love with computing"
}
